...
public enum Description {
    TASK_8_1 (8, "Keep Hydrated!", "Get number of litres Nathan will drink during entered time"),
    TASK_8_2 (8, "Volume of a cuboid", "Calculate the volume of a cuboid"),
	TASK_8_3 (8, "Miles per gallon to kilometers per liter", "Miles per gallon to kilometers per liter"),
	TASK_8_4 (8, "To square root or no to square", "description"),
	TASK_8_5 (8, "Count of positives / sum of negatives", "description"),
...
//    TASK_8_9("TASK 8.9\nFind numbers which are divisible by given number"),
    TASK_7_1(7, "Looking for a benefactor" ,"The function new_avg(arr, navg)" +
